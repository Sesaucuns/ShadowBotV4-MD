...
if (!args[0]) throw `*[❗] INGRESE UN ENLACE DE INSTAGRAM, EJEMPLO: ${usedPrefix + command}* https://www.instagram.com/reel/Cc0NuYBg8CR/?utm_source=ig_web_copy_link` 
try {
...
await await m.reply(`*⚠️ Error vuelve a intentarlo, si el error sigue pruebe con otra opción (${usedPrefix}ig, ${usedPrefix}ig2, ${usedPrefix}ig3)*`)
}}
