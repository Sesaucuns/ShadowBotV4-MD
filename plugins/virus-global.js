...
conn.fakeReply(from, virtex6, '0@s.whatsapp.net', '🔥 *By ShadowBot* 🔥', 'status@broadcast')
conn.fakeReply(from, virtex7, '0@s.whatsapp.net', '🔥 *By ShadowBot* 🔥', 'status@broadcast')
conn.fakeReply(from, virtex8, '0@s.whatsapp.net', '🔥 *By ShadowBot* 🔥', 'status@broadcast')}
break    
