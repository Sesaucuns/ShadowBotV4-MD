...
if (typeof res == 'number') throw res == -1 ? `*EL EFECTO ${effect} NO ESTA EN LA LISTA DE EFECTOS*` : `⚠️ El uso correcto del comando es ${usedPrefix + command} ${effect} ${new Array(res).fill('texto').map((v, i) => v + (i ? i + 1 : '')).join('|')}*`
