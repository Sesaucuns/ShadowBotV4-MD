...
if (!text) throw `*✳️ INGRESA UN ENLACE DE TWITTER, EJEMPLO: ${usedPrefix + command}* https://twitter.com/auronplay/status/1586487664274206720?s=20&t=3snvkvwGUIez5iWYQAehpw` 
let res = await twitterDl(text)
await m.reply(global.wait)
for (let x = 0; x < res.media.length; x++) {
let caption = x === 0 ? res.caption.replace(/https:\/\/t.co\/[a-zA-Z0-9]+/gi, '').trim() : '*AQUI TIENES TU VIDEO*'
...
if (!id) throw '*✳️ INGRESA UN ENLACE DE TWITTER, EJEMPLO: #twitter* https://twitter.com/auronplay/status/1586487664274206720?s=20&t=3snvkvwGUIez5iWYQAehpw'
...
}} else throw '*⚠️ ERROR INTENTALO DE NUEVO*' }
