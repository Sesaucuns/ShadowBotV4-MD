...
${isWin ? `@${(isSurrender ? room.game.currentTurn : room.game.winner).split('@')[0]} GANASTE 🎉, TE LLEVAS +4999 EXP` : isTie ? 'EL JUEGO TERMINO EN EMPATE 😐' : `TURNO DE @${room.game.currentTurn.split('@')[0]}`}
`.trim()
