...
if (new Date - global.db.data.users[m.sender].lastcofre < 86400000) throw `⚠️ YA RECLAMASTE TU RECOMPESA, VUELVE EN *${msToTime(time - new Date())}* PARA VOLVER A RECLAMAR`
...
let expp = Math.floor(Math.random() * 5000)
  ...
  global.db.data.users[m.sender].money += shadow
