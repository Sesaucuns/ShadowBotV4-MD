...
if (!text) throw `*INGRESA EL NOMBRE DE ALGUNA CATEGORÍA HENTAI, EJEMPLO: ${usedPrefix + command} miku*`
try {
m.reply(global.wait)
...
throw `*⚠️ERROR, VUELVA A INTENTARLO  Y/O PRUEBE CON OTRA CATEGORÍA*`
}}
