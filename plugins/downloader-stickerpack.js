...
if (!text) throw `*✳️ EJEMPLO DE USO DEL COMANDO ${usedPrefix + command}* https://getstickerpack.com/stickers/flork-memes-4-1`
try {
let url = text
...
await m.reply('*⚠️ Error inténtalo de nuevo.*')  
}}
